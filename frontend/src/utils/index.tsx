        ...
        >
            ...
            <div className="NavLink column" style={isHovered? {alignItems: "start"} : {alignItems: "center"}}>
                ...
                <div className="navItem">
                    {
                        isHovered ?
                            <a style={{fontFamily: 'Azeret Mono'}} className="navItem" href="/login"><HiUser/> Login</a> :
                            <HiUser/>
                    }
                </div>
                ...
                <div className="navItem">
                    {
                        isHovered ?
                            <a style={{fontFamily: 'Azeret Mono'}} className="navItem" href="/register"><HiUser/> Register</a> :
                            <HiUser/>
                    }
                </div>
            </div>
...
export function InputWithLabel({ id, label, type, name, required = false, className = '', onChange, error }: InputWithLabelProps) {
    ...
    return (
        <div className={`inputText width100 ${className} ${error ? "error" : ""}`}>
